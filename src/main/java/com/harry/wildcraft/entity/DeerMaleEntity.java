...
public class DeerMaleEntity extends Animal implements GeoEntity {
    ...
    public static final EntityDataAccessor<Boolean> IS_DYING_SYNC =
            SynchedEntityData.defineId(DeerMaleEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    // ==================== SOUNDS ====================
    @Override protected SoundEvent getAmbientSound() { return isDying() ? null : ModSounds.DEER_IDLE.get(); }
    @Override protected SoundEvent getHurtSound(DamageSource src) { return ModSounds.DEER_HURT.get(); }
    @Override protected SoundEvent getDeathSound() { return ModSounds.DEER_DEATH.get(); }
    @Override protected float getSoundVolume() { return 0.25f; }
    @Override public int getAmbientSoundInterval() { return 700; }
